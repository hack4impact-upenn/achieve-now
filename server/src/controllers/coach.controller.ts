...
import { createAttendanceOnDate, createCoachInDB, deleteAttendanceOnDate, getAllCoachesFromDB, updateAttendance } from '../services/coach.service';
...
const createCoach = async (
    ...
    const coach = await createCoachInDB(user_id, partner_site, mailing_address, media_waiver);
