        ...
        <Dialog open={open} onClose={() => setOpen(false)}>
          ...
          >
            <Stack spacing={2}>
              ...
              >
                <InputLabel htmlFor="link-field">First Grade Lunch Start Time</InputLabel>
                <OutlinedInput
              ...
              >
                <InputLabel htmlFor="link-field">First Grade Lunch End Time</InputLabel>
                <OutlinedInput
              ...
              >
                <InputLabel htmlFor="link-field">Second Grade Lunch Start Time</InputLabel>
                <OutlinedInput
                  id="firsgradelunchstarttime-field"
              ...
              >
                <InputLabel htmlFor="link-field">Second Grade Lunch End Time</InputLabel>
                <OutlinedInput
                  id="firsgradelunchendtime-field"
