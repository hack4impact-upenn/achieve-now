...
interface AddSchoolProps {
  ...
  addSchool: (name: string,
    ...
    second_grade_lunch_end_time: Date | null) => void;
}
...
function AddSchoolDialog({ open, setOpen, addSchool }: AddSchoolProps) {
  ...
  const [first_grade_lunch_start_time, setFirstGradeLunchStartTime] = useState<Date | null>(null);
  const [first_grade_lunch_end_time, setFirstGradeLunchEndTime] = useState<Date | null>(null);
  const [second_grade_lunch_start_time, setSecondGradeLunchStartTime] = useState<Date | null>(null);
  const [second_grade_lunch_end_time, setSecondGradeLunchEndTime] = useState<Date | null>(null);
